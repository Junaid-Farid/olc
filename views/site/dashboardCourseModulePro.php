<div class="config">
    <div class="top-text">
        <div class="col-md-12">
            <h4>View eModule Products</h4>
            <p class="p5">View eModule products for a specific eCourse.</p>
    ...
    <div class="col-md-12 dashboard">
        <div class="col-md-6">
            <h5 class="d-heading">Collateral Listing</h5>
            <div class="wrapper-course">
                <table class="table">
                    ...
                    <tr>
                        <td>URL</td>
                        <td>https://olc.oraclesoftruth.org</td>
                    </tr>
                    <tr>
                        <td>Forum</td>
                        <td>https://olc.oraclesoftruth.org/forumname</td>
                    </tr>
                    <tr>
                        <td>F-Giide</td>
                        <td>None</td>
