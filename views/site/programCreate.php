<div class="config">
    <div class="top-text">
        <div class="col-md-12">
            ...
            <p class="p5">Create, edit, archive, and add program options</p>
        </div>
    </div>  
    ...
    <div class="col-md-12">
        <div id="centeredmenu">
            <ul class="top-ul">
                <li id="li1" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('site/programcreate') ?>">Create</a></li>
