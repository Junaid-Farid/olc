<div class="config">
    ...
    <div class="col-md-12">
        <div id="centeredmenu">
            <ul class="top-ul">
                ...
                <li id="li3" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('site/supportfaqs') ?>">FAQs</a></li>
    ...
    <div class="col-md-12">
        <p> Review the list of frequestly asked questions here or search the database to get answers to questins most frequently asked. </p>
        <p>Enter a keyword(e.g. general, costs, pricing, programs, services, sponsorship, ads, financial aid, etc.)</p>
    </div>
