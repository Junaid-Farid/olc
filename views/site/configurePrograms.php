...
<div class="config">
    ...
    <div class="top-text">
        <div class="col-md-12">
            ...
            <p class="p-conf-1">Configure user programs, eCourses and save selections to database.</p>
            <p class="p-conf-2">Note: The system will auto populate the appropriate fields as shown.</p>
        </div>
    </div>
    <div class="col-md-12">
        <div id="centeredmenu">
        ...
        <div class="wrapper-program">
            ...
            <div class="col-md-3 col-md-offset-6">
                <div class="btn-right">
                    ...
                    <input type="button" class="btn btn-danger" value="Add Section">
                </div>
            </div>
        ...
        <div class="col-md-5 kill-padding">
            <form class="form-horizontal" role="form" id="">
                ...
                <div class="wrapper-settings">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 kill-padding" for=""></label>
                        <div class="col-sm-8">
                            <div class="">
                                <button type="submit" class="btn btn-danger">Load Data</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--Academic Report Setting-->
    <div class="col-md-12 br-conf">
        <div class="wrapper-program">
            <div class="col-md-3">
                <h4 class="h-4">Academic Report Settings</h4>
            </div>
            <div class="col-md-3 col-md-offset-6">
                <div class="btn-right">
