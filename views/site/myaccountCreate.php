<div class="top-text">
    <div class="col-md-12">
        ...
        <p class="p5">Configure My Account settings for all user accounts.</p>
...
<div class="col-md-12">
    <div id="centeredmenu">
        <ul class="top-ul">
            <li id="li2" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('site/myaccountcreate') ?>">Create</a></li>
        ...
        <form class="form-horizontal" role="form" id="">
            ...
            <div class="wrapper-settings">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control">
                            <option>Select Graduation Status</option>
                            <option>Option 1</option>
                            <option>Option 2</option>
                            <option>Option 3</option>
                        </select>
    ...
    <div class="col-md-4 d-btns">
        <form class="form-horizontal" role="form" id="">
            ...
            <div class="wrapper-settings">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="">Technology</label>
                    <div class="col-sm-3">
                        <div class="row">
                            <input type="text" class="form-control" id="" placeholder="Enter amount">
                        </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="">Residency</label>
                    <div class="col-sm-3">
                        <div class="row">
                            <input type="text" class="form-control" id="" placeholder="Enter amount">
                        </div>
