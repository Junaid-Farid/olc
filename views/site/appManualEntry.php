    ...
    <div class="col-md-12">
        <div id="centeredmenu">
            ...
            <div class="pull-right">
                <button type="submit" class="btn btn-danger" onclick="goBack()">Back</button>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <form class="form-horizontal" role="form" id="">
                <div class="wrapper-manualEntry">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="">Graduation Date</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="" placeholder="System Auto Populated">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="">Program of Study</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="" placeholder="System Auto Populated">
                        </div>
                    </div>
            ...
            <form class="form-horizontal" role="form" id="">   
                <div class="wrapper-manualEntry">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="" placeholder="System Auto Populated"><select class="form-control">
                                <option>Select One</option>
                                <option>Mustard</option>
                                <option>Ketchup</option>
                                <option>Relish</option>
    ...
    <div class="col-md-12">
        <div class="load">
            <div class="row">
                <div class="form-group">
                    <div class="pull-right">
                        <label>Generate Random User ID 12 digits</label> 
