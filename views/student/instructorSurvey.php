    ...
    <div class="col-md-12">
        <div id="centeredmenu">
            <ul class="top-ul">
                ...
                <li id="li2" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/instructorsurvey') ?>">Instructor</a></li>
            ...
            <div class="wrapper-assignment">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>6.</td>
                            <td>Instructor demonstrated a solid knowledge of course content.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
