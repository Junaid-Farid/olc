<div class="config">
    ...
    <div class="col-md-12 fiftyMarginTopSide" style="margin-bottom: 0px;  padding-right: 45px;">
        <div id="centeredmenu" class="menuWithAllSideBorder">
            <ul class="top-ul">
                ...
                <li id="li2"  class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/progressexams') ?>">Exams</a></li>
        ...
        <div class="col-md-12" style="border: 2px solid #999999;" >
            <div class="row"> 
                <div class="col-md-9 pLineHeight"> 
                    <div class="row">
                        <p class="graph-p">Progress Report by Exams</p> 
                        <div class="col-md-12"  id="ecourseLalExam" style="height: 450px;"> 
                            <div class="row">
