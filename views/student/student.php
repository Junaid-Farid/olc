...
<div class="top-text">
    <div class="col-md-12">
        <h4>Dashboard</h4>
        <p class="d-p font-size-16px">This is your student home page. Access any learning resources you need to interact, participate, and complete eCourses in the learning community.</p>
    </div>
</div>  
<div class="col-md-12">
    <div id="centeredmenu">
        <ul class="top-ul">
            <li id="li1" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/student') ?>">Main</a></li>
...
<div class="col-md-12 dashboard">
    ...
    <div class="col-md-4">
        ...
        <div class="bg-tbl block-large">
            ...
            <p class="heading">Instruction Design Technology</p>
            <table class="table borderless">
                <thead>
                    <tr>                 
                        <th>eCourse</th>
