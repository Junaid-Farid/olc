<div class="config">
    ...
    <div class="col-md-12">
                <div class="pull-right">
                    <span class="p5"><strong><a class="a_Blue" href="<?php echo Yii::$app->getUrlManager()->createUrl('student/supportnewticket') ?>"><span style="color: #000099;">start a new ticket</span></a></strong> </span> 
                </div>         
    </div>
...
<div class="col-md-12">
    <div class="col-md-4 fiftyMarginTopSide">
        <div class="col-sm-12">
            ...
            <div class="chatIcon">
                <ul>
                    <li style="list-style: none;"> No Open tickets </li>
<!--                    <p></p>
                    <li> </li>
                    <p></p>
                    <li></li>
    ...
    <div class="col-md-4 fiftyMarginTopSide">
        <div class="col-sm-12">
            ...
            <div class="chatIcon">
                <ul>
                    <li style="list-style: none;"> No Pending tickets</li>
<!--                    <p></p>
                    <li> </li>
                    <p></p>
                    <li> </li>
