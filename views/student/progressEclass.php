<div class="config">
    ...
    <div class="col-md-12 fiftyMarginTopSide" style="margin-right: 0px; padding-right: 40px;">
        <div id="centeredmenu" class="menuWithAllSideBorder">
            <ul class="top-ul">
                ...
                <li id="li1" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/progresseclass') ?>">eClass</a></li>
                <li id="li2"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/progressprojects') ?>">Projects</a></li>
                <li id="li2"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/progressforum') ?>">Forum</a></li>
            </ul>
        </div>
            ...
            <div class="row"> 
                <div class="col-md-9 pLineHeight"> 
                    <div class="row">
                        ...
                        <p class="col-md-offset-2 bold">Attendance Score: 7 | 7</p>
                        <div class="col-md-12"  id="ecourseClass" style="height: 450px;"> 
                            <div class="row">
