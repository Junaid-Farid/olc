    ...
    <div class="col-md-12 fiftyMarginTopSide">
        <div id="centeredmenu" class="menuWithAllSideBorder">
            <ul class="top-ul">
                ...
                <li id="li2" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/progressprojects') ?>">Projects</a></li>
            ...
            <div class="row"> 
                <div class="col-md-9 pLineHeight"> 
                    <div class="row">
                        ...
                        <div class="col-md-12"  id="ecourseProject" style="height: 450px;"> 
                            <div class="row">
