<div class="config">
    ...
    <div class="col-md-12 fiftyMarginTopSide">
        <div id="centeredmenu" class="menuWithAllSideBorder">
            <ul class="top-ul">
                <li id="li1"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/facultydescription') ?>">Description</a></li>
                <li id="li2" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/facultyprogress') ?>">Progress</a></li>
            ...
            <div class="row"> 
                <div class="col-md-9 pLineHeight"> 
                    <div class="row">
                        ...
                        <div class="col-md-12"  id="faculty_progress" style="height: 400px;"> 
                            <div class="row">
