<div class="config">
    <div class="top-text">
        <div class="col-md-12 margingBottom30" style="padding-bottom: 30px;">
            <h4>Feedback</h4>
    ...
    <div class="col-md-12">
        <div id="centeredmenu">
            <ul class="top-ul">
                <li id="li1" class="activate"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('student/ecoursesurvey') ?>">eCourse</a></li>
            ...
            <div class="wrapper-assignment">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>1.</td>
                            <td>Content supported stated learning outcomes and objectives.</td>
                        ...
                        <tr>
                            <td>2.</td>
                            <td>Content will be useful to my work and personal life.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>3.</td>
                            <td>Content was organized in a way conducive to my learning.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>4.</td>
                            <td>eCourse format was amenable to my schedule.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>5.</td>
                            <td>Multiemedia technologies enhanced the learning experience.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>6.</td>
                            <td>Pace if the eCourse was appropriate and flexible.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>7.</td>
                            <td>Assognments contributed to my knowledge and understanding.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                        ...
                        <tr>
                            <td>8.</td>
                            <td>Evaluation and grading measurements were fair.</td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
                            <td><input type="radio" class="Form-label-radio"/></td>
