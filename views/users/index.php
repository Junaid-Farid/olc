...
<div class="config">
    <div class="top-text">
        <div class="col-md-12">
            ...
            <p class="p5">View, edit, save, and archive accounts.</p>
        </div>
    </div>  
    <div class="col-md-12">
        <div id="centeredmenu">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>XXXXX</td>
                        <td>Student</td>
                        <td><a href="<?php echo Yii::$app->getUrlManager()->createUrl('site/userapplication')?>" class="btn btn-danger" role="button">Edit</a></td>
                        <td><a href="<?php echo Yii::$app->getUrlManager()->createUrl('site/editprograms')?>" class="btn btn-danger" role="button">Edit</a></td>
                    </tr>
                    <tr>
                        <td>CA7501348920</td>
                        <td>Thomas</td>
